...
const EditDealOfTheWeek = () => {
  ...
  const loadDeal = async () => {
    try {
      setLoadingDeal(true);
      const data = await dealOfTheWeekAPI.getById(id);
      const deal = data.deal;

      if (deal) {
        setFormData({
          title: deal.title || "Deal of the Week",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await dealOfTheWeekAPI.update(id, {
      ...
      setSuccess("Deal of the Week updated successfully!");
      setTimeout(() => {
  ...
  return (
    <div className="container-fluid p-3 p-md-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h4 className="mb-0 fw-bold">Edit Deal of the Week</h4>
        <button
          type="button"
...
export default EditDealOfTheWeek;
