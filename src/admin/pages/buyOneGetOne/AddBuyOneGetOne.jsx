...
const AddBuyOneGetOne = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess("Buy One Get One section created successfully!");
      setTimeout(() => {
        navigate("/admin/buy-one-get-one");
      }, 1500);
    } catch (err) {
      console.error(err);
      setError(err.message || "Failed to create Buy One Get One section");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container-fluid p-3 p-md-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h4 className="mb-0 fw-bold">Add Buy One Get One</h4>
        <button
          type="button"
                  ...
                  <>
                    <div className="mb-2">
                      <div className="form-check">
                        ...
                        />
                        <label className="form-check-label" htmlFor="selectAllBogo">
...
export default AddBuyOneGetOne;
